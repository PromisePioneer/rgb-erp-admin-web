...
export const patrolReportsApi = {
    ...
    /**
     * Get patrol rounds grouped by area with checkpoint details
     * GET /api/admin/patrol-reports/rounds
     */
    getRounds: async (params?: PatrolReportsFilters) => {
        const {data} = await apiClient.get<ApiResponse<PatrolAreaRounds[]>>('/admin/patrol-reports/rounds', {
            params,
        })
        return data
    },
