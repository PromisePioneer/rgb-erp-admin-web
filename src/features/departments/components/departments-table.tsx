...
import { DepartmentsFormModal } from './departments-form-modal'
...
export function DepartmentsTable() {
  ...
  const handlePageChange = useCallback(
    (newPage: number) => {
      ...
      fetchDepartments({ ...filters, page: newPage })
    },
    [fetchDepartments, filters, pagination.last_page]
  )
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin menghapus {selectedIds.size} department
