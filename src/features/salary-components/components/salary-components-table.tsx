/**
 * Salary Components Table Component
...
import { SalaryComponentsFormModal } from './salary-components-form-modal'
import { useSalaryComponentsStore } from '../store/salary-components-store'
import { SalaryComponentsFilters } from './salary-components-filters'
import type { SalaryComponent } from '../types/salary-components.types'
...
export function SalaryComponentsTable() {
  ...
  const [editingSalaryComponentId, setEditingSalaryComponentId] = useState<number | undefined>(undefined)
  ...
  const handleAddNew = () => {
    setFormMode('create')
    setEditingSalaryComponentId(undefined)
    setShowFormModal(true)
  }

  const handleEdit = (component: SalaryComponent) => {
    setFormMode('edit')
    setEditingSalaryComponentId(component.id)
    setShowFormModal(true)
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin menghapus {selectedIds.size} salary component yang dipilih? Tindakan ini tidak dapat dibatalkan.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <SalaryComponentsFormModal
        open={showFormModal}
        onOpenChange={setShowFormModal}
        mode={formMode}
        salaryComponentId={editingSalaryComponentId}
      />
    </div>
  )
}
