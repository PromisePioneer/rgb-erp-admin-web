                    ...
                    <div className="bg-white text-gray-900 rounded-lg shadow-sm overflow-hidden">
                        ...
                        <div className="p-6 border-b border-gray-200">
                            <div className="flex items-start justify-between">
                                <div className="flex items-center gap-3">
                                    <div
                                        className="h-11 w-11 rounded-lg bg-[#C7A254] flex items-center justify-center text-black font-bold">
                                        RGB
                                    </div>
                                    <div>
                            ...
                            {isMonthly && (
                                <p className="text-sm text-gray-500 mt-4">
                                    Kehadiran: {selectedPayroll.present_days} / {selectedPayroll.working_days} hari
                                    {selectedPayroll.ter_category && (
                                        <> · Kategori TER {selectedPayroll.ter_category}</>
                                    )}
                                </p>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 p-6">
                            ...
                            <div>
                                ...
                                {deductions.length === 0 ? (
                                    <p className="text-gray-400 py-1 text-sm">Tidak ada</p>
                                ) : (
                        ...
                        {isMonthly && selectedPayroll.bpjs_employer && (
                            <div className="px-6 pb-6">
                                <p className="text-[11px] text-gray-400 border-t border-gray-100 pt-3">
                                    BPJS Perusahaan (biaya perusahaan): Kesehatan{' '}
