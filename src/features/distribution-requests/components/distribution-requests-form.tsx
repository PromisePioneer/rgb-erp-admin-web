...
import {ArrowLeft, Plus, Trash2, Save, Send, User, MessageSquare} from 'lucide-react'
import {cn} from '@/lib/utils'
import {Button} from '@/components/ui/button'
import {Input} from '@/components/ui/input'
import {Skeleton} from '@/components/ui/skeleton'
import {AsyncSelect, type SelectOption} from '@/components/async-select'
import {useDistributionRequestsStore} from '@/features/distribution-requests'
import {distributionRequestsApi} from '../api/distribution-requests-api'
import {productsApi} from '@/features/products/api/products-api'
import type {DestinationType} from '@/features/distribution-requests'
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    {approval.approver_name || approval.acted_at ? `by ${approval.approver_name || 'System'}` : 'Menunggu...'}
                                                </p>
                                            </div>
                                        </div>
                          ...
                          approval.status === 'approved' ? 'Disetujui' : 'Ditolak'}
                                    ...
                                    {approval.note && (
                                        <div className="flex gap-2 pl-13">
                                            ...
                                            <div
                                                className="text-sm text-muted-foreground bg-muted/50 rounded-md p-2 flex-1">
