...
import { useEmployeeCode } from '../hooks/useEmployeeCode'
...
export function EmployeesForm() {
  ...
  // Form sections state
  const [children, setChildren] = useState<Array<{ name: string; birth_date: string; birth_place: string; education: string }>>([])
  const [siblings, setSiblings] = useState<Array<{ type: string; name: string; age: string; education: string; job: string }>>([])
  const [educations, setEducations] = useState<Array<{ from: string; to: string; school: string; city: string; cert: boolean }>>([])
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <AsyncSelect
                ...
                onChange={(value) => form.setValue('position_id', value as number | null | undefined, { shouldValidate: true })}
            ...
            <div className="space-y-2">
              ...
              <Input {...form.register('name', { required: 'Name is required' })} placeholder="John Doe" />
            ...
            <div className="space-y-2">
              ...
              <select {...form.register('religion')} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
            ...
            <div className="space-y-2">
              ...
              <select {...form.register('blood_type')} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
                <option value="">Select...</option>
            ...
            <div className="space-y-2">
              ...
              <select {...form.register('marital_status')} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
                <option value="">Select...</option>
            ...
            <div className="space-y-2">
              ...
              <Input type="number" {...form.register('height', { valueAsNumber: true })} placeholder="170" />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium">Weight (kg)</label>
              <Input type="number" {...form.register('weight', { valueAsNumber: true })} placeholder="65" />
            </div>
          </div>

          <div className="mt-4 space-y-2">
            <label className="text-sm font-medium">Address</label>
            <textarea {...form.register('address')} placeholder="Street address" className="w-full min-h-[80px] px-3 py-2 text-sm rounded-md border border-input" />
          </div>
        </section>
        ...
        <section className="bg-card rounded-lg border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input type="number" {...form.register('base_salary', { valueAsNumber: true })} placeholder="5000000" />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium">PTKP Status</label>
              <select {...form.register('ptkp_status')} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
                <option value="">Select...</option>
            ...
            <div className="space-y-2">
              ...
              <select {...form.register('drive_license_type')} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
                <option value="">Select...</option>
            ...
            <div className="space-y-2">
              ...
              <select {...form.register('status', { valueAsNumber: true })} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
        ...
        <section className="bg-card rounded-lg border p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <select {...form.register('housing_status')} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
                <option value="">Select...</option>
          ...
          <div className="space-y-4">
            {trainings.map((training, index) => (
              <div key={index} className="flex gap-4 items-start bg-muted/30 p-4 rounded-lg">
                ...
                <Button type="button" variant="ghost" size="icon" onClick={() => removeTraining(index)}>
                  <Trash2 className="h-4 w-4 text-destructive" />
                </Button>
              </div>
            ))}
