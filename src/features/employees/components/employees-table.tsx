...
import {EmployeesImportModal} from '@/features/employees'
    ...
    const columns: DataTableColumn<Employee>[] = [
        {
            ...
            cell: (row) => {
                ...
                return (
                    <div
                        className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-xs font-medium">
                    ...
                    {row.user_email ? (
                        <div className="space-y-1">
                            <div className="flex items-center gap-2">
                                <span
                                    className="font-mono text-muted-foreground truncate max-w-30">{row.user_email}</span>
                            </div>
            ...
            <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Apakah Anda yakin ingin menghapus {selectedIds.size} employee yang dipilih? Tindakan ini
