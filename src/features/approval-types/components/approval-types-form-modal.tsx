...
import { Plus, Trash2, GripVertical, Users, User, ChevronUp, ChevronDown } from 'lucide-react'
...
import type { ApprovalType, ApprovalTypeDetail, StepPayload, PositionOption, EmployeeOption } from '../types/approval-types.types'
...
export function ApprovalTypesFormModal({ type, onClose }: ApprovalTypesFormModalProps) {
  const { saveType, isSubmitting, fetchTypeById, positionsOptions, employeesOptions, fetchPositionsOptions, fetchEmployeesOptions } = useApprovalTypesStore()
  ...
  const updateStep = (index: number, field: keyof StepPayload, value: number | string) => {
    const newSteps = [...steps]
                ...
                {steps.map((step, index) => (
                  ...
                  >
                    ...
                    <Select
                      ...
                      onValueChange={(value) => updateStep(index, 'approver_id', parseInt(value))}
                    >
