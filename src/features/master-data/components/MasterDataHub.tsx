...
const allMasterDataItems: MasterDataItem[] = [
  // Referensi
  { id: 'provinces', name: 'Provinces', nameId: 'Provinsi', description: 'Data province', descriptionId: 'Data provinsi', icon: Globe, section: 'referensi', countKey: 'provinces', isImplemented: true },
  { id: 'client-types', name: 'Client Types', nameId: 'Tipe Klien', description: 'Data client type', descriptionId: 'Data tipe klien', icon: Tags, section: 'referensi', countKey: 'client_types', isImplemented: true },
  { id: 'banks', name: 'Banks', nameId: 'Bank', description: 'Data bank', descriptionId: 'Data bank', icon: Building2, section: 'referensi', countKey: 'banks', isImplemented: true },
  { id: 'bank-accounts', name: 'Bank Accounts', nameId: 'Akun Bank', description: 'Data bank account', descriptionId: 'Data akun bank', icon: Building2, section: 'referensi', countKey: 'bank_accounts', isImplemented: true },

  // HRD
  { id: 'departments', name: 'Departments', nameId: 'Departemen', description: 'Data department', descriptionId: 'Data departemen', icon: Users, section: 'hrd', countKey: 'departments', isImplemented: true },
  { id: 'roles', name: 'Roles', nameId: 'Peran', description: 'Data role', descriptionId: 'Data peran', icon: Users, section: 'hrd', countKey: 'roles', isImplemented: true },
  { id: 'employees', name: 'Employees', nameId: 'Karyawan + User', description: 'Data employee + user account', descriptionId: 'Data karyawan + akun user (auto)', icon: Users, section: 'hrd', countKey: 'employees', isImplemented: true },
  { id: 'shifts', name: 'Shifts', nameId: 'Shift', description: 'Data shift', descriptionId: 'Data shift kerja', icon: Clock, section: 'hrd', countKey: 'shifts', isImplemented: true },
  { id: 'salary-components', name: 'Salary Components', nameId: 'Komponen Gaji', description: 'Salary components', descriptionId: 'Komponen gaji (tunjangan, potongan)', icon: Coins, section: 'hrd', isImplemented: true },

  // Klien
  { id: 'clients', name: 'Clients', nameId: 'Klien', description: 'Data client', descriptionId: 'Data klien', icon: Building2, section: 'klien', countKey: 'clients', isImplemented: true },
  { id: 'areas', name: 'Areas', nameId: 'Area', description: 'Data area', descriptionId: 'Data area klien', icon: MapPin, section: 'klien', countKey: 'areas', isImplemented: true },
  { id: 'poss', name: 'POS', nameId: 'POS', description: 'Data POS', descriptionId: 'Data titik POS', icon: MapPin, section: 'klien', countKey: 'poss', isImplemented: true },

  // Produk
  { id: 'product-categories', name: 'Product Categories', nameId: 'Kategori Produk', description: 'Product categories', descriptionId: 'Kategori produk', icon: Tags, section: 'produk', countKey: 'product_categories', isImplemented: true },
  { id: 'products', name: 'Products', nameId: 'Produk', description: 'Data product', descriptionId: 'Data produk', icon: Package, section: 'produk', countKey: 'products', isImplemented: true },

  // Gudang
  { id: 'warehouses', name: 'Warehouses', nameId: 'Gudang', description: 'Data warehouse', descriptionId: 'Data gudang', icon: Warehouse, section: 'gudang', countKey: 'warehouses', isImplemented: true },
  ...
  { id: 'tangible-asset-classes', name: 'Tangible Asset Classes', nameId: 'Kelas Aktiva', description: 'Asset classes', descriptionId: 'Kelas aktiva tetap', icon: Layers, section: 'akunting', isImplemented: true },

  // Administrasi
  { id: 'settings', name: 'Settings', nameId: 'Pengaturan', description: 'System settings', descriptionId: 'Pengaturan sistem', icon: Settings, section: 'administrasi', isImplemented: true },
]
