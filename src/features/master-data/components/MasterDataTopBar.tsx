...
export function MasterDataTopBar({
  ...
  const getItemName = (itemId: string): string => {
    const names: Record<string, string> = {
      provinces: 'Provinsi', 'client-types': 'Tipe Klien', banks: 'Bank', 'bank-accounts': 'Akun Bank',
      departments: 'Departemen', roles: 'Peran', employees: 'Karyawan + User', shifts: 'Shift', 'salary-components': 'Komponen Gaji',
      clients: 'Klien', areas: 'Area', poss: 'POS',
      'product-categories': 'Kategori Produk', products: 'Produk',
      warehouses: 'Gudang',
      'daily-task-items': 'Item Tugas Harian',
      'chart-of-accounts': 'Daftar Akun', 'tangible-asset-classes': 'Kelas Aktiva',
      settings: 'Pengaturan',
    }
