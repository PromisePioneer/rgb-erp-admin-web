              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl border p-5">
                  <div className="flex items-center gap-2 text-muted-foreground mb-3">
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wider">Issue Date</span>
                  </div>
              ...
              <div className="grid grid-cols-5 gap-6">
                ...
                <div className={selectedItem.notes ? 'col-span-3' : 'col-span-5'}>
                  <div className="rounded-xl bg-primary/5 border border-primary/20 p-5 space-y-2">
                    ...
                    <div className="flex justify-between text-lg font-bold border-t border-primary/20 pt-3 mt-3">
                      <span>Total</span>
                      <span className="font-mono text-primary">{formatCurrency(selectedItem.total)}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {selectedItem.paid_at && (
                <div className="rounded-xl bg-green-50 border border-green-200 p-5">
                  <div className="flex items-center gap-3 text-green-800">
                    ...
                    <span className="font-semibold">Paid on {formatDate(selectedItem.paid_at)}</span>
                  </div>
                </div>
              )}
            </div>
