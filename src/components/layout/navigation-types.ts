...
export const navigationSections: NavSection[] = [
    ...
    },
    {
        ...
        items: [
            ...
            {label: 'inventory', path: '/inventory', menu: 'Product', icon: 'scan', badge: 'new'},  // Unified inventory tracking
            ...
            {label: 'distribution_requests', path: '/distribution-requests', menu: 'Distribution Request', icon: 'git-branch'},
            {label: 'fund_requests', path: '/fund-requests', menu: 'Fund Request', icon: 'wallet'},
